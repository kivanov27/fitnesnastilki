...
const Checkout = () => {
    ...
    return (
        <div className="w-[75rem] mx-auto my-10 flex-1 flex">
            ...
            {/* Right side */}
            <div className="w-1/2 bg-gray-300 px-5">
                ...
                <div className="border-b border-gray-500">
                    ...
                    <p className="my-2 bg-gray-100 p-3">Плащане в брой при доставка</p> 
                </div>
                ...
                <p className="py-5 border-b border-gray-500 text-sm">
                    ...
                    <a href="politika-za-poveritelnost" className="font-semibold hover:text-primary"> политиката за поверителност.</a>
                </p>
                ...
                <div className="mt-2">
                    ...
                    <label htmlFor="terms" className="ms-2 text-sm">
                        ...
                        <a href="/pravila-usloviya" className="font-semibold hover:text-primary"> правилата и условията<span className="text-red-500"> *</span></a>
                    </label>
                </div>

                <button className="w-full p-3 my-4 bg-primary text-white hover:bg-primaryDim transition-colors duration-300">
                    Поръчване
                </button>
            </div>
        </div>
